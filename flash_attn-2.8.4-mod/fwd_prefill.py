# This patch is for flash_attn-2.8.4-py3-none-win_amd64 with amd_aiter-0.0.0-py3-none-win_amd64
# Put at \aiter\ops\triton\_triton_kernels\flash_attn_triton_amd\
import warnings
import torch
import triton
...
def get_fwd_prefill_configs(autotune: bool):
    ...
    if not autotune:
        ...
        if arch.name == "gfx950":
            ...
            return [
                triton.Config({"BLOCK_M": 128, "BLOCK_N": 16, "PRE_LOAD_V": False, "waves_per_eu": 1,}, num_warps=4, num_stages=2,),
            ]
        elif arch.is_rdna:
