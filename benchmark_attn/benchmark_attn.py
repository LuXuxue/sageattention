...
test_cases = [
    ...
    ("SDXL_Self_1", 1, 10, 10, 5120, 5120, 64),
    ("SDXL_Self_2", 1, 20, 20, 1280, 1280, 64),
    ("SDXL_Self_3", 1, 10, 10, 11520, 11520, 64),
    ("SDXL_Self_4", 1, 20, 20, 2880, 2880, 64),
    ("SDXL_Cross_Short_1", 1, 10, 10, 5120, 77, 64),
    ("SDXL_Cross_Short_2", 1, 20, 20, 1280, 77, 64),
    ("SDXL_Cross_Short_3", 1, 10, 10, 11520, 77, 64),
    ("SDXL_Cross_Short_4", 1, 20, 20, 2880, 77, 64),
    ("SDXL_Cross_Long_1", 1, 10, 10, 5120, 154, 64),
    ("SDXL_Cross_Long_2", 1, 20, 20, 1280, 154, 64),
    ("SDXL_Cross_Long_3", 1, 10, 10, 11520, 154, 64),
    ("SDXL_Cross_Long_4", 1, 20, 20, 2880, 154, 64),
    
    # 2. Anima (MHA: h_q == h_kv)(Self=长/16×宽/16。例：1280×1536 -> 1280/16*1536/16=7680)
    ("Anima_Self", 1, 16, 16, 7680, 7680, 128),
    ("Anima_Cross", 1, 16, 16, 7680, 512, 128),
