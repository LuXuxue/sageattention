...
def get_sdpa_reference(q, k, v):
    ...
    # 恢复为 [Batch, SeqLen, Heads, Dim] 并转回 FP16 以便比对
...
# ==========================================
test_cases = [
    # 1. SDXL(Self1=长/16×宽/16, Self2=Self1/4。例：1024×1280 -> 1024/16*1280/16=5120)
    ...
    # 2. Anima(Self=长/16×宽/16。例：1280×1536 -> 1280/16*1536/16=7680)
...
def run_benchmarks():
    ...
    for name, b, h, sq, sk, d in test_cases:
        ...
        sdpa_tflops = calculate_tflops(b, h, sq, sk, d, sdpa_time)
