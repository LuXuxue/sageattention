...
def forward(q, k, v, q_scale, k_scale, tensor_layout="HND", output_dtype=torch.float16, pv_accum_dtype="fp32"):
...
def sageattn(
    ...
    **kwargs: Any,
    ...
    if not is_causal:
        o = forward(q_int8, k_int8, v, q_scale, k_scale, tensor_layout=tensor_layout, output_dtype=dtype, pv_accum_dtype=pv_accum_dtype)
    else:
